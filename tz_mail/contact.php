...
if($_POST)
{
	...
	if(!empty($g_secret_key) && (!empty($value['g-recaptcha-response'])))
	{
			...
			// API FUNCTION CALL //
				switch ($export_mail_type) 
				{
					...
					case 'tz_active':
						...
						break;
					case 'tz_custom':
						themezaa_email($subscribe_email,$user_name,$phone_num,$comment,$purchase_email,$email_subject,$msg_php_email_sent,$msg_php_email_not_sent);
						break;
					case 'tz_campain':
						themezaa_campaign($subscribe_email,$user_name,$msg_subscribed_success,$msg_invalid_api);
						break;
					case 'tz_response':
						themezaa_getresponse($subscribe_email,$user_name,$msg_subscribed_success);
						break;
					case 'tz_mailchimp':
						themezaa_mailchimp($subscribe_email,$user_name,$last_name,$msg_subscribed_success,$msg_invalid_api,$msg_mailchimp_error);
						break;
					case 'tz_mailerlite':
 	...
 	// API FUNCTIONS //
	function themezaa_email($subscribe_email,$user_name,$phone_num,$comment,$purchase_email,$email_subject,$msg_php_email_sent,$msg_php_email_not_sent)
	{
		$to = $purchase_email;
		...
		$message .= "<html>
					...
					<tr>
					<td colspan='2' align='center' valign='top'><img style=' margin-top: 15px; ' src='http://www.somos.mx/html/leadgen/builder/images/logo-black-big.png' ></td>
					</tr>
					<tr>
	...
	function themezaa_mailchimp($subscribe_email,$user_name,$last_name,$msg_subscribed_success,$msg_invalid_api,$msg_mailchimp_error)
	{
