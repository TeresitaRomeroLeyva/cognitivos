...
$customer_email = "tromero@somos.mx"; //
//
...
$mail->setFrom('romeroteresita.10@gmail.com', 'Soporte');//must be a verified email address
...
$mail->Subject = 'SOMOS Multimedia® solicitud de cotización MisClientes';
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
$mail->msgHTML($message);
//Replace the plain text body with one created manually
$mail->AltBody = 'Tiene un nuevo mensaje! '.$email.' su  contraseña es: '.$password.', ya puede iniciar sesion.';
...
if (!$mail->send()) {
    ...
    echo json_encode(array("message" => "Solicitud enviada, revise su email","errorfound"=>false));
}