...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <div class="header-style8">                
                        ...
                        <div class="pull-right">
                            ...
                            <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse pull-right">
                                 <ul class="nav navbar-nav">
                                        <li class="propClone"><a class="inner-link" href="index.php" >Inicio</a></li>
                                        <li class="propClone"><a class="inner-link" href="miCuenta.php" >Perfil</a></li>
                                        <li class="propClone"><a class="inner-link" href="Catalogo.php" >Catalogo</a></li>
                                        <li class="nav-button propClone float-left btn-medium sm-no-margin-tb sm-no-margin-left"><a href="register.php" class="btn-medium btn btn-circle bg-blue text-black no-letter-spacing">Registrarme</a> </li>
                                        <li class="nav-button propClone float-left btn-medium sm-no-margin-tb sm-no-margin-left"><a href="iniciarsesion.php" class="btn-medium btn btn-circle bg-blue text-black no-letter-spacing">Iniciar sesion</a> </li>
                ...
                <section class="no-padding cover-background tz-builder-bg-image bgFoto" data-img-size="(W)1920px X (H)750px" >
                    <div class="container one-fourth-screen position-relative">
                        <div class="slider-typography text-center">
                            <div class="slider-text-middle-main">
                                <div class="slider-text-middle">
                                    <!-- slider text -->
                                    <div class="col-md-12 sheader-banner">
                ...
                <div class="container">                    
                    <div class="row">
                        ...
                        <!-- image -->
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            <img class="margin-thirteen-bottom xs-margin-twenty-seven-bottom" src="<?php echo base_url("images/application-about-mobile.png");?>" data-img-size="(W)958px X (H)115px" alt="">
                        </div>
                        <!-- end image -->
                    </div>                    
        ...
        <script type="text/js" src="/assets/js/jquery.min.js"></script>
        <script type="text/js" src="/assets/js/jquery.appear.js"></script>
        <script type="text/js" src="/assets/js/smooth-scroll.js"></script>
        <script type="text/js" src="/assets/js/bootstrap.min.js"></script>
        <!-- wow animation -->
        <script type="text/js" src="/assets/js/wow.min.js"></script>
        <!-- owl carousel -->
        <script type="text/js" src="/assets/js/owl.carousel.min.js"></script>        
        <!-- images loaded -->
        <script type="text/js" src="/assets/js/imagesloaded.pkgd.min.js"></script>
        <!-- isotope -->
        <script type="text/js" src="/assets/js/jquery.isotope.min.js"></script> 
        <!-- magnific popup -->
        <script type="text/js" src="/assets/js/jquery.magnific-popup.min.js"></script>
        <!-- navigation -->
        <script type="text/js" src="/assets/js/jquery.nav.js"></script>
        <!-- equalize -->
        <script type="text/js" src="/assets/js/equalize.min.js"></script>
        <!-- fit videos -->
        <script type="text/js" src="/assets/js/jquery.fitvids.js"></script>
        <!-- number counter -->
        <script type="text/js" src="/assets/js/jquery.countTo.js"></script>
        <!-- time counter  -->
        <script type="text/js" src="/assets/js/counter.js"></script>
        <!-- twitter Fetcher  -->
        <script type="text/js" src="/assets/js/twitterFetcher_min.js"></script>
        <!-- main -->
