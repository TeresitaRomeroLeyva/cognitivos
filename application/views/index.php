        ...
        <div class="header-style8">                
                        ...
                        <div class="pull-right">
                            ...
                            <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse pull-right">
                                 <ul class="nav navbar-nav">
                                        ...
                                        <li class="nav-button propClone float-left btn-medium sm-no-margin-tb sm-no-margin-left"><a href="<?php echo base_url()?>Check_in" class="btn-medium btn btn-circle bg-blue text-black no-letter-spacing">Registrarme</a> </li>
                                        <li class="nav-button propClone float-left btn-medium sm-no-margin-tb sm-no-margin-left"><a href="<?php echo base_url()?>Log_in" class="btn-medium btn btn-circle bg-blue text-black no-letter-spacing">Iniciar sesion</a> </li>
                ...
                <div class="container">                    
                    <div class="row">
                        ...
                        <!-- image -->
                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                            <img class="margin-thirteen-bottom xs-margin-twenty-seven-bottom" src="<?php echo base_url("assets/images/application-about-mobile.png");?>" data-img-size="(W)958px X (H)115px" alt="">
                        </div>
                        <!-- end image -->
                    </div>                    
